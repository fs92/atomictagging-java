...
public interface IAtomService {
	 ...
	 */
	IAtom create( String tag, String data, String hashCode );
	...
	/**
	 * Returns a list of atoms that are not tagged with atoms from {@link CoreTags}. Some atoms with tags from
